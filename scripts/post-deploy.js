...
function checkDeploymentOutput() {
  ...
  if (fs.existsSync(sitemapPath)) {
    console.log('✅ sitemap.xml exists in output');
  } else {
    console.log('⚠️  sitemap.xml not found in output (may be generated at runtime)');
  }
...
function checkFileSizes() {
  ...
  if (fs.existsSync(sitemapPath)) {
    ...
    const sizeKB = Math.round(stats.size / 1024);
    console.log(`✅ sitemap.xml size: ${sizeKB}KB`);
  }
...
function main() {
  ...
  if (allPassed) {
    ...
    console.log('📝 Note: Sitemap is generated by @nuxtjs/sitemap module at /sitemap.xml');
    process.exit(0);
  } else {
